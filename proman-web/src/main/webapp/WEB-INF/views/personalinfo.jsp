		...
		<table>
			...
			<tr>
				<td>
					...
					<br/>
					<input type="text" id="state" maxlength="2" style="width:25%;"/>
					
					
					<input type="text" maxlength="5" id="zip" style="width:25%;"/>-<input type="text" maxlength="4" id="county" style="width:25%;"/>
				</td>
				<td>
